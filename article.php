<?php
	...
	$get = [];
	$set = [];
	$get["cat"] = Article::getbyId( (int) $_GET["id"]);
	$result = $get["cat"]->title . " | " . NAME;
	$set[] = $get["cat"];
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<meta name="description" content="<?php echo $set->text;?>">
	<meta name="keywords" content="<?php echo $set->title;?>">
...
<body>
	...
	<hr class="hund">
		...
		<?php foreach($set as $article): ?>
		<div class="container">
				<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
				<div class="panel">
					<div class="panel-heading">
					<i>Added <?php echo date("d.m.Y", $article->pub_date);?></i>
					...
					<a href="/" class="btn-lg btn-default">Back</a>
				</div>
				</div>
				</div>
			</div>
